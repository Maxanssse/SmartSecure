...
if (!empty($_POST) && !empty($_POST['email'])) {
    ...
    if ($user) {
        ...
        http://localhost/smartsecure/reset.php?id=$user->id&token=$reset_token";
    ...
    <form action="" method="post">
        <fieldset>
            <div class="div1">
                ...
                <input type="email" name="email" id="email" class="imput">
            </div>
            <div class="div2" style="margin-top: 20px;">
                <input class="imput2" type="submit" value="Soumettre">
            </div>
        </fieldset>
    </form>
</div>
