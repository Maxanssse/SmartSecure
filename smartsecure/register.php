    ...
    <form action="" method="post">
        <fieldset>
            ...
            <div class="div2">
                ...
                <input type="email" id="email" class="imput" name="email">
            </div>
            <div class="div2">
            ...
            <div class="div2">
                ...
                <input type="password" id="password" class="imput" name="password_confirm">
            </div>
            <input type="submit" class="imput" value="S'inscrire">
        </fieldset>
    </form>
</div>
