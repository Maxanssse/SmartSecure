    ...
    <form action="" method="post">
        <fieldset>
            <div class="div1">
                ...
                <input type="password" name="password" id="password" class="imput">
            </div>
            <div class="div1">
                <label for="password">Confirmation du mot de passe</label>
                <input type="password" name="password_confirm" id="password" class="imput">
            </div>
            <div class="div1" style="margin-top: 20px;">
                <input class="imput" type="submit" value="Réinitialiser votre mot de passe">
            </div>
        </fieldset>
    </form>
</div>
